...
3. **Preço v1 existe, mas a operação ainda precisa de infraestrutura**
   ...
   - o Admin já possui catálogo ativo protegido, rascunhos editáveis, versionamento persistente, publicação auditada e vigência imediata/programada para rotas fixas e tarifas por localidade; ainda faltam edição estrutural de localidades/zonas e resolução robusta de todas as localidades externas;
