...
8. **Privacidade, LGPD e operação da autenticação**
   ...
   - o Core já possui processo administrativo via API/CLI com chaves revogáveis, escopos e auditoria para provisionar/aprovar/suspender motorista; falta o painel web com login humano próprio e implantação operacional;
